...
<?php
		$emailid=$_GET['emailid'];
		 ...
		 $result=$mysqli->query("select * from student where emailid='$emailid' ");
...
<?php
$result = $mysqli->query("Select * from images where emailid='$emailid' ORDER BY uploaded desc");
...
<td align="center"><?php echo $row['uploaded']; ?></td>
<td align="center"><a href="http://mxbridge.mywebcommunity.org/delete_image.php?id=<?php echo $row['id']; ?>"> Delete</a></td>
