...
$mysqli= NEW MYSQLi('fdb27.runhosting.com','3733521_user','Connect@123','3733521_user');
$result = $mysqli->query("SELECT * FROM alumni where averified=1 order by firstname"); 
...
?>
          <tr> 
<td><image src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>"  style="width:150px; height:100px; padding:0px 30px 0px 30px;"></image></td>
<td><?php echo $row['firstname']; echo "  "; echo $row['lastname']; ?></td>		
<td><?php echo $row['joinyear'];?></td>
<td><?php echo $row['rollno'];?></td> 
<td><a href="http://mxbridge.mywebcommunity.org/alumnidetail.php?emailid=<?php echo $emailid3; ?>&profile=<?php echo $row['emailid']; ?>">View Profile</a></td>
            </tr>    
