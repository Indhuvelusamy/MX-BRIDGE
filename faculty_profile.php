...
<?php 
	 ...
	 $result=$mysqli->query("select * from faculty where emailid='$emailid'");
         $row = mysqli_fetch_assoc($result);
         $result1=$mysqli->query("select * from faculty_image where emailid='$emailid'");
...
<form method="POST" action="update_facultyprofile.php" enctype="multipart/form-data">
...
<div class="input-box">
<h4>
Last Name<div class="star">*</div></h4>
                ...
                <div class="input-box">
                 <h4>
Email ID<div class="star">*</div></h4>
...
<div class="input-group">
                <div class="input-box">
                <h4>
Password<div class="star">*</div></h4>
                    <input type="text" name="password" value="<?php echo $row['password']; ?>" class="name" >
                    
                </div>
                <div class="input-box">
                <h4>
Mobile Number<div class="star">*</div></h4>
                     <input type="tel" name="mobile" value="<?php echo $row['phoneno']; ?>" class="name" >
                    
                </div>
				<div class="input-box">
                                <h4>
Faculty ID<div class="star">*</div></h4>
                    <input type="text" name="id" value="<?php echo $row['rollno']; ?>" class="name" >
...
<div class="input-box1">
                    <h4>
City</h4>
<input type="text" name="city" value="<?php echo $row['city']; ?>"  class="name">
...
<div class="input-box1">
<h4>
Job Title<div class="star">*</div></h4>
                    <input type="text" class="name" name="job-title" value="<?php echo $row['jobtitle']; ?>" list="job-title"  autocomplete="off">
		<datalist id="job-title" >
			...
			<option>Lab Technician</option>
                ...
                <div class="input-box">
                <h4>
Change Profile<div class="star"></div></h4>
