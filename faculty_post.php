...
<?php 
	...
	$result1 = $mysqli->query("select * from post order by id DESC");
        $result2=$mysqli->query("select * from faculty_image where emailid='$emailid'");
...
<div class="label3" >&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;Year :</div>
...
<div class="label44" name="phonenumber" >&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;<?php echo $row3['phoneno']; ?></div>
</div>
<?php 
if($row3['mca']=="Yes") { ?>
...
<input type="submit" name="share" value="share" class="sp" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://mxbridge.mywebcommunity.org/edit_post.php?emailid=<?php echo $emailid; ?>" class="link">Edit my posts</a>
 ...
 <?php }
	...
	while($row = $result1->fetch_assoc()){
        $e=$row['emailid'];
	 $r= $mysqli->query("select firstname,lastname from faculty where emailid='$e' union select firstname,lastname from alumni where emailid='$e'");
         $row1 = $r->fetch_assoc();
         $r4= $mysqli->query("select * from faculty_image where emailid='$e' union select * from alumni_image where emailid='$e'");
         $row4 = $r4->fetch_assoc();
	?>
        <br>
...
$URL="http://mxbridge.mywebcommunity.org/faculty_post.php?emailid=".$emailid;
