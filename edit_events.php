...
<?php
		$emailid=$_GET['emailid'];
		 ...
		 $result=$mysqli->query("select firstname,lastname,aff from student where emailid='$emailid' union select firstname,lastname,aff from faculty where emailid='$emailid' ");
...
<?php
$result = $mysqli->query("Select * from events where emailid='$emailid' ORDER BY uploaded");
...
<td align="center"><a href="http://mxbridge.mywebcommunity.org/update_events.php?id=<?php echo $row['id']; ?>"> Edit</a></td>
<td align="center"><a href="http://mxbridge.mywebcommunity.org/delete_events.php?id=<?php echo $row['id']; ?>"> Delete</a></td>
</tr>
</tbody>
