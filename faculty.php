...
<section class="header">
        <div class="wrap">
<div class="container">
    <div class="title">Faculty Account</div>
    <div class="content">
	<form method="POST" action="">
		<div class="user-details">
          <div class="input-box">
          <span class="details">Roll Number</span>
                <input type="text" name="roll_no" pattern="[A-Za-z0-9]{7}" placeholder="FACULTY ID" required autocomplete="off">
               </div>
        <div class="input-box">
		...
		<datalist id="start-year" >
			...
			<option>2021</option>
              ...
              <input type="radio"  name="MCA" value="Yes" id="dot-1">
          <input type="radio" name="MCA" value="No" id="dot-2">
          <span class="gender-title">MCA in PSG TECH</span>
          <div class="category">
            <label for="dot-1">
		...
		<input type="text" name="job" list="job-title" autocomplete="off">
...
if (isset($_POST['submit2']))
 {
	 ...
	 $aff=$_POST['aff'];
        ...
        $end=$_POST['end-year'];
         $jobtitle=$_POST['job'];
         $mca=$_POST['MCA'];
        $insert=$mysqli->query("insert into faculty(emailid,firstname,lastname,password,vkey,phoneno,city,joinyear,endyear,jobtitle,mca) values('$emailid','$firstname','$lastname','$password','$vkey','$phoneno','$city','$start','$end','$jobtitle','$mca')");
