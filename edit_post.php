...
<?php
$result = $mysqli->query("Select * from post where emailid='$emailid' ORDER BY date_posted desc");
...
<td align="center"><a href="http://mxbridge.mywebcommunity.org/update_post.php?id=<?php echo $row['id']; ?>"> Edit</a></td>
<td align="center"><a href="http://mxbridge.mywebcommunity.org/delete_post.php?id=<?php echo $row['id']; ?>"> Delete</a></td>
</tr>
</tbody>
<?php  } }
?>
